...
set :application, "CurrentData"
set :repository,  "git@github.com:gdevine/CurrentData.git"
set :deploy_to, "/var/www/html/currentdata"
set :scm, :git
set :branch, "master"
set :user, "30036712"
set :group, "deployers"
...
server "u0144.uws.edu.au", :app, :web, :db, :primary => true
